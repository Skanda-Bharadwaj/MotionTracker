...
ENABLE_KALMAN            = 1;
ENBLE_ADAPTIVE_SEARCH    = 1;
ENABLE_EXHAUSTIVE_SEARCH = 0;
...
imdDir = dir('./caltrain/gray');
nFrames = size(imdDir, 1) - 2;
firstFrame = double(imread(sprintf('./%s/gray/%s00%d.ras', ...
